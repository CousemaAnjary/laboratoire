...
export const utilisateurData: Utilisateur[] = [
    { nom: "John", prénom: "Doe", email: "john.doe@example.com", statut: "Actif" },
    { nom: "ABDILLAH", prénom: "Cousema", email: "cousema@example.com", statut: "Inactif" },
    { nom: "BEN MOHAMED", prénom: "Nour", email: "nour@gmail.com", statut: "Actif" },
];
